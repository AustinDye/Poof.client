<template>
      ...
      <div class="row groomer-profile">
        ...
        <div class="col-8">
          ...
          <p>
            ...
            laboriosam cupiditate necessitatibus distinctio. Adipisci doloribus
            obcaecati voluptate, error a consequatur magnam, nemo aliquam
            perferendis quos voluptatem laborum! Sit, repellendus modi.
          </p>
        </div>
      </div>
    </div>
  ...
  <div class="col-12">
    <div
      class="row d-flex justify-content-between align-content-center p-3 py-4 pb-5 gallery-holder"
    >
